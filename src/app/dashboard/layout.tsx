...
type BookingSheetData = {
  facilityId?: string;
  startTime?: Date;
}

type DashboardContextType = {
  openBookingSheet: (data?: BookingSheetData) => void;
};
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const [initialBookingData, setInitialBookingData] = useState<BookingSheetData | undefined>();

  const openBookingSheet = (data?: BookingSheetData) => {
  ...
  return (
    <DashboardContext.Provider value={{ openBookingSheet }}>
      <div className="grid min-h-screen w-full md:grid-cols-[220px_1fr] lg:grid-cols-[280px_1fr]">
        ...
        <div className="flex flex-col">
          <header className="flex h-14 items-center gap-4 border-b bg-muted/40 px-4 lg:h-[60px] lg:px-6">
            ...
            <Button variant="secondary" size="sm" className="mr-4" onClick={() => openBookingSheet()}>
